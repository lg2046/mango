defmodule Mango.CRMTest do
  ...
  test "build_customer/0 return a customer changeset" do
    assert %Ecto.Changeset{data: %Customer{}} = CRM.build_customer
  end

  test "build_customer/1 return a customer changeset with applied" do
    attrs = %{"name" => "John"}
  ...
  test "create_customer/1 returns a customer for invalid data" do
    invalid_attrs = %{}
  ...
  test "get_customer_by_credential" do
    valid_attrs = %{
      "name" => "John",
      "email" => "john@example.com",
      "password" => "secret",
